...
public class dots2 extends PApplet {
...
public void setup() {
  ...
  for (TableRow row : settingsTable.rows ()) {
    ...
    U_NUM_ITERS = PApplet.parseInt(row.getString("numIters")) <= U_NUM_ITERS_MAX ? 
    PApplet.parseInt(row.getString("numIters")) : U_NUM_ITERS_MAX;
...
//}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "dots2" };
    if (passedArgs != null) {
